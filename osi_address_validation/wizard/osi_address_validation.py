...
class OSIAdressValidation(models.TransientModel):
    _name = 'osi.address.validation'
    _description = 'OSI Address Validation'
    ...
    def default_get(self, fields_list):
        res = super(OSIAdressValidation, self).default_get(fields_list)
    ...
    def accept_validate_address(self):
        ...
        if active_id:
            ...
            vals = {
                ...
                "osi_date_validation": fields.Date.today()
