...
odoo.define("website_portal_contact.tour_portal_contacts", function (require) {
    ...
    tour.register(
        ...
        [
            ...
            //     in_modal: false,
            //     run: function () {}, // Check
            // },TODO remove Unexpected empty method 'run' while pre-commit checks
            {
            ...
            //     extra_trigger: '#wrapwrap .c_total span:contains("1")',
            //     in_modal: false,
            //     run: function () {}, // Check
            // },
            {
            ...
            //     extra_trigger: '#wrapwrap .c_total span:contains("0")',
            //     in_modal: false,
            //     run: function () {}, // Check
            // },
            {
            ...
            // },
            {
                content: _t("Go back to Home"),
                trigger: ".navbar > .o_portal_submenu .fa-home",
                run: "click",
                position: "bottom",
            },
        ]
