...
var AbstractGroupedOne2ManyRenderer = ListRenderer.extend({
    ...
    groupTitleTemplate: 'partner_default_group_row', // Template used to render the title row of a group
    ...
    */
    ...
    _renderTrashIcon: function() {
        return qweb.render('partner_trash_button');
    },
...
var ResumeLineRenderer = AbstractGroupedOne2ManyRenderer.extend({
    ...
    groupTitleTemplate: 'partner_resume_group_row',
    dataRowTemplate: 'partner_resume_data_row',
...
var SkillsRenderer = AbstractGroupedOne2ManyRenderer.extend({
    ...
    dataRowTemplate: 'partner_skill_data_row',
