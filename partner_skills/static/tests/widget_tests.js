odoo.define('partner_skills.field_one_to_many_group_tests', function (require) {
    "use strict";
    ...
    QUnit.module('skills_widgets', {
        ...
        QUnit.test('resumé one2many field group by field render', async function (assert) {
            ...
            var form = await createView({
                ...
                arch: '<form string="Partners">' +
                    '<field name="line_ids" widget="partner_resume">' +
                        '<tree>' +
                            '<field name="name"/>' +
        ...
        QUnit.test('skills one2many field group by field render', async function (assert) {
            ...
            var form = await createView({
                ...
                data: this.data,
                arch: '<form string="Partners">' +
                    '<field name="skill_ids" widget="partner_skills">' +
                        '<tree>' +
                            '<field name="skill_id"/>' +
