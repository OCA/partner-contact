...
class ResPartner(models.Model):
    ...
    def _compute_search_relation_type_id(self):
        self.write({
            'search_relation_type_id': False
        })

    def _compute_search_relation_partner_id(self):
        self.write({
            'search_relation_partner_id': False
        })

    def _compute_search_relation_date(self):
        self.write({
            'search_relation_date': False
        })

    def _compute_search_relation_partner_category_id(self):
        self.write({
            'search_relation_partner_category_id': False
        })
