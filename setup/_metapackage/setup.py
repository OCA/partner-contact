...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-partner_coc>=15.0dev,<15.1dev',
        ...
        'odoo-addon-partner_readonly_security>=15.0dev,<15.1dev',
