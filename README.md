...
[partner_bank_acc_type_constraint](partner_bank_acc_type_constraint/) | 16.0.1.0.0 | [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | Adds constraint on bank account type
