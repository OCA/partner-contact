...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:5ae72fab043d8d2bb50183fd538fa895b0d5ffdfefdcfd62bbd610c9a4dc95da
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fpartner--contact-lightgray.png?logo=github
    :target: https://github.com/OCA/partner-contact/tree/18.0/partner_multi_relation_archive_propagate
    :alt: OCA/partner-contact
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/partner-contact-18-0/partner-contact-18-0-partner_multi_relation_archive_propagate
...
4. Archive a company:
   ...
   -  Use the **"Archive Contact and Children"** button (not the gear
      menu) to propagate archiving to related partners.
   -  The wizard lists both hierarchy contacts and contact-type relation
      partners. Remove any row to exclude that partner from the
      operation.
   ...
   ..
      ...
      **Note:** The gear (⚙) **Archive** action archives only the
      company itself and never propagates to relation partners,
      regardless of the *Force propagation outside UI* setting.
...
`feedback <https://github.com/OCA/partner-contact/issues/new?body=module:%20partner_multi_relation_archive_propagate%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/partner-contact <https://github.com/OCA/partner-contact/tree/18.0/partner_multi_relation_archive_propagate>`_ project on GitHub.
