...
4.  Archive a company:
    - Archive the company (via the UI wizard or via non-UI operations,
      depending on your configuration in partner_archive_propagate).
...
5.  Unarchive the company:
    ...
    - All partners (tree descendants or relation-based) that were
      archived because of this company (`propagated_from_id`) are
      unarchived and have the field cleared.
